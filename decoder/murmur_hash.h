...
inline uint32_t MurmurHash2(void const *key, int len, uint32_t seed=DEFAULT_SEED)
{
...
#else // 32-bit
typedef uint32_t MurmurInt;


// Note - This code makes a few assumptions about how your machine behaves -
// 1. We can read a 4-byte value from any address without crashing
// 2. sizeof(int) == 4
inline uint32_t MurmurHash2 ( const void * key, int len, uint32_t seed=DEFAULT_SEED)
{
